...
-- CreateEnum
CREATE TYPE "WebsiteStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED');
...
-- AddForeignKey
ALTER TABLE "Website" ADD CONSTRAINT "Website_submittedById_fkey" FOREIGN KEY ("submittedById") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
